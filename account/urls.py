...
from account.views import SettingsView, GithubAuthView, GithubReposView, GithubHooksView
from account.views import GithubHooksBackendView
...
urlpatterns = [
    ...
    url(r"^github/auth/$", GithubAuthView.as_view(), name="account_github_auth"),
    url(r"^github/repos/$", GithubReposView.as_view(), name="account_github_repos"),
    url(r"^github/hooks/$", GithubHooksView.as_view(), name="account_github_hooks"),
    url(r"^github/hooks/backend/$", GithubHooksBackendView.as_view(), name="account_github_hooks_backend"),
]
