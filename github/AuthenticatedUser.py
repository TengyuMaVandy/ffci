...
class AuthenticatedUser(github.GithubObject.CompletableGithubObject):
    ...
    """
    Add get hooks by authenticated user  03/14/16
    by tym
    """
    def get_hooks(self, repo,
                  type=github.GithubObject.NotSet, sort=github.GithubObject.NotSet, direction=github.GithubObject.NotSet):
        """
        :calls: `GET /user/repos <http://developer.github.com/v3/repos>`_
        :param repo: string webhook for a certain repo
        :param type: string
        :param sort: string
        :param direction: string
        :rtype: :class:`github.PaginatedList.PaginatedList` of :class:`github.Repository.Repository`
